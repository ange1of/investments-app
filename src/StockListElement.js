...
function StockListElement({ ticker, title, price, priceChangePercent, currency, sector }) {
    return (
        <div className="StockListElement">
            <div className="title">
                <h3>{title} ({ticker})</h3>
            </div>
            <div className="priceChange">
                <svg width="10" height="10">
                    {priceChangePercent > 0 ? <polygon points="0,10 5,0 10,10" fill="green"/> : 
